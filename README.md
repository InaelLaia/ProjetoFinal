...
- HTML: Para criação de páginas web
- Javascript: Para manipulação avançada de páginas web
...
2. Inserir no arquivo "application.properties" localizado no caminho "src/main/resources" os dados para conexão com o banco de dados, "user" e "password".  
3. Fazer o Build do Projeto.
4. Executar o Projeto.
5. Acessar http://localhost:8080/ no navegador de preferência.  
